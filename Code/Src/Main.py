...
import plot_helpers
from Classifiers import Naive_Bayes_Classifier, SVM_Classifier, Passive_Agressive_Classifier
from Time_checker import run_time_stats
...
def Naive_Bayes_Checker():
    '''
    This method runs the Naive bayes models based on count, tfidf vectorizing.
    :return: return the predictions(numpy array with predicted values) of the best of all (count, tfidf).
    '''
    global actual_test_labels, accuracy_dict_naive_bayes, Naive_obj
    predictions = {'count' : tuple() , 'tfidf' : tuple()}
...
def SVM_Checker():
    '''
    This method runs the Naive bayes models based on count, tfidf
    :return: return the predictions(numpy array with predicted values) of the best of all (count, tfidf).
    '''
...
def analysis(model,predictions):
    ...
    print("\n######################################################################")
    return {'count' : accuracy_for_count , 'tfidf' : accuracy_for_tfidf}
